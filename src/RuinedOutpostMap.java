...
public final class RuinedOutpostMap {
    ...
    public enum Prop {
        PALISADE("barricade-mud",48,56,76,12),
        COT("cot",56,52,80,22),
        STANDARD("standard",22,90,20,12),
        WALL("wall-mud",48,47,82,12),
        BARREL("barrel-mud",24,53,32,16),
        TREE("tree-mud",31,102,24,12),
    ...
    public enum Decoration {
        ...
        GATE_PIER("gate-pier-mud",32,104,false,48,24),
        ...
        WALL_END("wall-end-mud",24,47,false,40,24);
        final String file;
