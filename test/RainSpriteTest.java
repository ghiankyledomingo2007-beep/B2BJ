...
public final class RainSpriteTest {
    public static void main(String[] args) throws Exception {
        ...
        streak.set(panel,marker(32,16));splash.set(panel,marker(128,32));
        ...
        assert art!=null&&art.getWidth()==32&&art.getHeight()==16 : "two native16px streak variants";
        CombatArtTest.check("assets/effects/rain_streaks.png",16,16,2,1,2);
        CombatArtTest.check("assets/effects/rain_splashes.png",16,16,8,2,8,true);
